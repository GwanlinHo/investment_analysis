...
def generate_html_report(report_data, date_str, summary_data, yield_curve_plot_b64=None, fundamental_data=None, yield_data=None):
    ...
    <head>
        ...
        <style>
            ...
            #weekly-news-focus li, #ai-analysis-report li {{ margin-bottom: 10px; color: #555; word-wrap: break-word; overflow-wrap: break-word; white-space: normal; }}
    ...
    <body>
        <div class="container">
            ...
            <footer style="text-align: center; margin-top: 50px; padding: 20px; color: #777; font-size: 12px; border-top: 1px solid #eee;">
                <p>[Warning] 免責聲明：本報告僅供研究參考，不構成任何投資建議。內容由 AI 自動收集與整理，可能包含錯誤或過時資訊，建議投資人與官方數據或其他來源交叉驗證。金融市場波動劇烈，投資人應自行評估風險並承擔投資結果。</p>
